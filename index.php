    ...
    <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1 style="color:black;">Indian Food Right Here </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:black;">1. </span >Choose Restaurant</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:black;">2. </span>Order Food</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:black;">3. </span>Delivery or take out</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Indian Restaurants</h2>
                <p class="lead">A taste of tradition with a modern twist
            </div>
            <div class="row">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We have got your covered with menus from a variety of delivery restaurants online.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a dish</h3>
                            <p>We have got your covered with a variety of delivery restaurants online.</p>
                        </div>
                    </div>
